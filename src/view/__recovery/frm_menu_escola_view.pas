...
type
  ...
  Tfrm_menuEscola = class(TForm, IEscolaAdminView)
    ...
    procedure lbl_professorResponsavel_addNEdit_Turma_EscolaMenuClick(Sender: TObject);
  private
...
procedure Tfrm_menuEscola.lbl_professorResponsavel_addNEdit_Turma_EscolaMenuClick(Sender: TObject);
begin
